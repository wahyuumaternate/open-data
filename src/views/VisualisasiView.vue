            ...
            <div class="hero-content" data-aos="fade-up">
              ...
              <div class="hero-stats" v-if="!loading && stats.total_visualizations">
                ...
                <div class="stat-item" v-if="stats.visualizations_this_month">
                  ...
                  <span
                    >{{ stats.visualizations_this_month.toLocaleString('id-ID') }} Bulan Ini</span
                  >
                </div>
              </div>
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-3">
            <select class="form-select" v-model="selectedTopic" @change="filterVisualisasi">
              ...
              <option v-for="(count, topic) in stats.by_topic" :key="topic" :value="topic">
                {{ topic }} ({{ count }})
              </option>
            </select>
          </div>
          <div class="col-md-3">
            <select class="form-select" v-model="selectedType" @change="filterVisualisasi">
              ...
              <option v-for="(count, type) in stats.by_type" :key="type" :value="type">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-8">
              ...
              <div class="item-meta mb-2">
                ...
                <span class="badge bg-info me-2" v-if="visualisasi.data_source">{{
                  visualisasi.data_source
                }}</span>
              ...
              <div class="item-author">
                ...
                >
                  ...
                  >{{ visualisasi.organization_name || visualisasi.user.organization.name }}
                </small>
                <small class="text-muted me-3">
...
.chart-icon.pie_chart {
  background: linear-gradient(135deg, #b197fc, #d0bfff); /* ungu pastel */
  color: #fff;
}

.chart-icon.bar_chart {
  background: linear-gradient(135deg, #74c0fc, #a5d8ff); /* biru pastel */
  color: #fff;
}

.chart-icon.line_chart {
  background: linear-gradient(135deg, #63e6be, #96f2d7); /* hijau pastel */
  color: #fff;
}

.chart-icon.area_chart {
  background: linear-gradient(135deg, #ffe066, #ffd43b); /* kuning pastel */
  color: #fff;
}
